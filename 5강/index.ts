...
function solution2(x?: number): void {
    1 + 1;
}
solution2();
...
function homework(x?: string): void {
    if (x) {
...
function homework2(x: string | number): void {
...
function homework3(money, house, charm): string | void {
    let score = 0;
